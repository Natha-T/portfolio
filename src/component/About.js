    ...
    return (
        <div className='h-screen bg-backc'>
            ...
            <div className='max-w-[1000px] w-full grid sm:grid-cols-2 gap-8 px-4'>
                ...
                <div>
                    <p className='text-lg text-gray-300'> Je suis passioné de nouvelles technologie, etre a la pointe de ce qui se fait
                        est super et j'en apprend encore plus. Je suis spécialisé Front-End,Web3 et permet
                        de vous accompagné dans l'éevolution de votre projet. Je suis disponible donc n'hesitez
